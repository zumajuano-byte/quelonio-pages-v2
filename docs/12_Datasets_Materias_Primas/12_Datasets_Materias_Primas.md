# 12. Datasets Materias Primas

## Visión general
Módulo de datasets predictivos para materias primas cerveceras (malta, lúpulo, levadura). Fuente de verdad: Excel/Sheets > Biblia > Supuestos. Agua no se asume en datasets.

## Estructura del módulo
- `_schema/`: Esquemas y plantillas.
- `maltas/items/`: Items de malta.
- `lupulos/items/`: Items de lúpulo.
- `levaduras/items/`: Items de levadura.

## Maltas
- [MALTA__pilsen_ar_generic](maltas/items/MALTA__pilsen_ar_generic.md)
- [MALTA__pale_ale_ar_generic](maltas/items/MALTA__pale_ale_ar_generic.md)
- [MALTA__caramelo_medio_ar_generic](maltas/items/MALTA__caramelo_medio_ar_generic.md)
...
## Levaduras
- [LEVADURA__us05_market](levaduras/items/LEVADURA__us05_market.md)
