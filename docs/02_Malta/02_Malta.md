...
## Ruta rápida (para operar sin sufrir)
1) **Parte 1 (Fundamentos operables):**
   - Hub: [Malta Parte 1 — 00_INDEX](Malta_Parte1_DEEP/00_INDEX.md)
   - Índice: [Malta Parte 1 — 00_Indice](Malta_Parte1_DEEP/00_Indice_Malta_Parte1.md)

2) **TP (registro mínimo de insumo + molienda):**
   - [TP — Log Malta (COA + recepción + molienda)](Malta_Parte1_DEEP/90_TP_Log_Malta_COA_y_Molienda.md)

---

## Puentes recomendados
- Agua (pH/alcalinidad/calcio condicionan performance del mash):
  - [01 — Agua](../01_Agua/01_Agua.md)
- Recetas/Specs (targets y decisiones de formulación):
  - [08 — Recetas y formulación](../08_Recetas_Formulacion/08_Recetas_Formulacion.md)
- Sensorial (feedback loop: cata → ajuste de receta):
  - [11 — Sensorial](../11_Sensorial/11_Sensorial.md)

---

## Partes disponibles
- [Malta Parte1 DEEP](Malta_Parte1_DEEP/00_Indice_Malta_Parte1.md)
- [Malta Parte2 DEEP](Malta_Parte2_DEEP/00_Indice_Malta_Parte2.md)
